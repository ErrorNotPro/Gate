...
def pp(ccx, amount="20.00", retry_count=1):
    ...
    try:
        ...
        response = r.get('https://tdcaustralia.com.au/donations/sporsor-a-tdc-sahiwal-hospital-unit-department/', headers=headers, timeout=8)
        ...
        headers = {
            ...
            'origin': 'https://tdcaustralia.com.au',
            'referer': 'https://tdcaustralia.com.au/donations/sporsor-a-tdc-sahiwal-hospital-unit-department/',
            'sec-ch-ua': '"Chromium";v="137", "Not/A)Brand";v="24"',
            'sec-ch-ua-mobile': '?1',
            'sec-ch-ua-platform': '"Android"',
        ...
        data = {
            ...
            'give-current-url': 'https://tdcaustralia.com.au/donations/sporsor-a-tdc-sahiwal-hospital-unit-department/',
            'give-form-url': 'https://tdcaustralia.com.au/donations/sporsor-a-tdc-sahiwal-hospital-unit-department/',
        ...
        response = r.post('https://tdcaustralia.com.au/wp-admin/admin-ajax.php', cookies=r.cookies, headers=headers, data=data, timeout=8)
        ...
        multipart_data = MultipartEncoder({
            ...
            'give-current-url': (None, 'https://tdcaustralia.com.au/donations/sporsor-a-tdc-sahiwal-hospital-unit-department/'),
            'give-form-url': (None, 'https://tdcaustralia.com.au/donations/sporsor-a-tdc-sahiwal-hospital-unit-department/'),
        ...
        response = r.post(
            'https://tdcaustralia.com.au/wp-admin/admin-ajax.php',
            params=params,
            headers=headers,
            data=multipart_data,
            timeout=8,
